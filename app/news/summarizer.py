...
def build_digest_with_openai(
    ...
    system = (
        ...
        "Also include notable releases and updates developers actually use: AI coding tools "
        "(e.g. Cursor, Copilot-class products), model/API announcements from major labs "
        "(OpenAI, Anthropic, Google, etc.), and important dev-infrastructure news "
        "(e.g. Composer, Docker, cloud/edge, package ecosystems) when the impact on "
        "day-to-day engineering is clear. "
        ...
        "Skip general AI hype with no line to building software, pure robotics, "
